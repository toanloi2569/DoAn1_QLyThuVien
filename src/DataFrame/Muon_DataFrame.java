...
public class Muon_DataFrame extends Abstract_DataFrame{
	...
	public Muon_DataFrame(DatabaseTable vls) {
		super(vls);
		prepareMTGUI();
	...
	void setupAddButtonAction() {
		AddButton_Data.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				MuonMT_EditFrame t = new MuonMT_EditFrame(Muon_DataFrame.this);
			}
		});
	}
